...
import { getFieldFocusedSuggestions } from '../../services/dashboard';
import { errorResponse, successResponse } from '../../utils/api.utils';
import { DashboradCourseDTO } from 'types/course.types';

export async function fieldSuggestionsController(
  req: Request,
  res: Response,
  next: NextFunction
) {
  try {
    ...
    const data = await getFieldFocusedSuggestions(userId);
